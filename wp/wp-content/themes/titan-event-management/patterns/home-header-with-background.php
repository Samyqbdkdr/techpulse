<?php
/**
 * Title: Home Header With Background
 * Slug: titan-event-management/home-header-with-background
 */
?>
...
<main id="primary" class="wp-block-cover inner-banner-section" style="margin-top:0;margin-bottom:0;min-height:232px">
  ...
  <div class="wp-block-cover__inner-container">
    ...
    <h2
      ...
      style="font-size:50px;font-style:normal;font-weight:700"><?php esc_html_e('Blog', 'titan-event-management'); ?></h2>
    <!-- /wp:heading -->
  </div>
</main>
<!-- /wp:cover -->