...
/**
 * Title: Related Post
 * Slug: titan-event-management/related-post
 * Categories: titan-event-management, related-post
 */
?>
...
<h4 class="wp-block-heading has-text-align-left"><strong><?php esc_html_e('Related Posts :-','titan-event-management'); ?></strong></h4>
<!-- /wp:heading -->
...
<!-- wp:read-more {"content":"Read More","style":{"typography":{"textDecoration":"none"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}},"spacing":{"padding":{"right":"14px","left":"14px","top":"10px","bottom":"10px"}},"border":{"radius":"8px"}},"backgroundColor":"primary","textColor":"contrast","fontSize":"small"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
