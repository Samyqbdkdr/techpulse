 ...
 * Slug: titan-event-management/archive-header-with-background
 */
?>
...
<main id="primary" class="wp-block-cover inner-banner-section" style="margin-top:0;margin-bottom:0;min-height:232px">
  ...
  <div class="wp-block-cover__inner-container">
    <!-- wp:query-title {"type":"archive","textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast","fontSize":"x-large","fontFamily":"inter"} /-->
  </div>
</main>
<!-- /wp:cover -->