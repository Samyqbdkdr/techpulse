 ...
 * Slug: titan-event-management/search-header-with-background
 */
?>
...
<main id="primary" class="wp-block-cover inner-banner-section" style="margin-top:0;margin-bottom:0;min-height:232px">
  ...
  <div class="wp-block-cover__inner-container">
    <!-- wp:paragraph {"placeholder":"Write title…","className":"has-inter-font-family","style":{"typography":{"textAlign":"center"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast","fontSize":"x-large"} -->
    <p
      class="has-text-align-center has-inter-font-family has-contrast-color has-text-color has-link-color has-x-large-font-size">
      <strong><?php esc_html_e('Search Page', 'titan-event-management'); ?></strong></p>
    <!-- /wp:paragraph -->
  </div>
</main>
<!-- /wp:cover -->